...
<body id="body">
  <nav class="navbar navbar-expand-lg sticky-top bg-body-tertiary py-0 shadow-sm me-auto">
    <a class="navbar-brand d-flex align-items-center ms-1" href="dashboard.php">
      ...
      <strong style="font-family: Century Gothic, sans-serif;">NEOCASH|Approval Site</strong>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav" style="font-family: Raleway; font-size: 13.5px;">
        <li class="nav-item <?= $page == 'submitapproval.php' ? 'selected' : ''; ?>">
          <a class="nav-link" href="submitapproval.php"><i class="fa fa-plus text-success" aria-hidden="true"></i>
            Submit Approval</a>
        </li>
      </ul>
