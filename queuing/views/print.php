        ...
        <div class="br-section-wrapper">
            ...
            <div class="row">
                <div class="col text-primary font-weight-bold">
                    <span><b>Overall Balance:</b> </span><span
                        class="text-dark"><?= number_format($row['totalbalance'], 2, '.', ',') ?></span>
            ...
            <hr>
            <img class="form-control form-control-sm fileThumbnail mx-auto d-block" id="front"
                src="../<?= $row['front'] ?>" alt="File Thumbnail">
            <?php if ($row['back'] != null) { ?>
                <img class="form-control form-control-sm fileThumbnail mx-auto d-block" id="back"
                    src="../<?= $row['back'] ?>" alt="File Thumbnail">
            <?php } ?>
            <div class="text-right">
                <button class="btn btn-sm btn-primary d-print-none" onclick="window.print();">Print</button>
                <button type="button" class="btn btn-sm btn-danger d-print-none"
