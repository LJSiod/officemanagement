...
while ($row = mysqli_fetch_assoc($result)) {
    $available_counters[] = array('userid' => $row['userid'], 'fullname' => $row['fullname']);
}

$_SESSION['counterid'] = $available_counters;
$id = $_SESSION['userid'];
    ...
    <div class="container-fluid">
        <div class="br-pagebody">
            ...
            foreach ($available_counters as $counter) {
                ...
                echo '<div class="col-md" id="c' . $id . '">
                        <div class="br-section-wrapper bg-light counter" id="counter' . $id . '">
                            <div class="sticky-top bg-light" style="z-index: 100;">
                                <div class="d-flex justify-content-between">
                                    <h6 class="font-weight-bold">Counter ' . $counternumber . '</h6>
                                    ' . ($admin ? '<span class="small">Running Collection: <strong><span id="c' . $id . 'running"></span></strong></span>' : '') . '
                                </div>
            ...
            echo '</div>';
            ?>
            <div class="br-section-wrapper bg-light queue mt-3">
