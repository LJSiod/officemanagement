...
$query = "SELECT qi.id, qi.clientname, qi.cashonhand, qi.type, b.name as branchname FROM queueinfo qi LEFT JOIN branch b ON qi.branchid = b.id WHERE qi.branchid = $branchid AND date = '$currentdate' AND cashonhandstatus = 'RECEIVED' ORDER BY qi.id DESC";
