...
$query = "SELECT b.id, b.Name, b.userid, u.fullname FROM branch b LEFT JOIN users u ON b.userid = u.id";
                ...
                <div class="modal-body">
                    <div>
                        <select class="form-control form-control-sm" name="counters" id="counters">
                            ...
                            <option value="2">Mae Demetais</option>
                            <option value="3">Belle Delos Santos</option>
                        </select>
                    </div>
                </div>
