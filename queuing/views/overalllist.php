...
$query = "SELECT qi.id, qi.clientname, qi.cashonhand, qi.date, qi.type, b.name as branchname FROM queueinfo qi LEFT JOIN branch b ON qi.branchid = b.id WHERE qi.branchid = $branchid AND cashonhandstatus = 'RECEIVED' ORDER BY qi.id DESC";
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <p class="label">Date Settled: </p><?php echo date('Y-m-d', strtotime($row['date'])); ?>
                            </td>
                            <td class="text-right">
