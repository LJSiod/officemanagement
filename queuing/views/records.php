...
<body>
    <div class="container-fluid mt-3">
        <div class="br-pagebody">
            <div class="br-section-wrapper bg-light recordsdiv">
        ...
        <script>
            ...
            $(document).ready(function () {
                var table = $('#records').DataTable({
                    ...
                    columns: [
                        { data: 'queueno' },
                        <?php if ($admin) { ?> { data: 'branchname' }, <?php } ?>
                        { data: 'type' },
                        { data: 'clientname' },
                        { data: 'loanamount' },
                        { data: 'totalbalance' },
                ...
                $(document).on('contextmenu', '#records tbody tr', function (e) {
                    ...
                    var menu = $('<div class="dropdown-menu" id="actiondropdown" style="display:block; position:absolute; z-index:1000;">'
                        ...
                        + <?= $admin ? '\'<a class="dropdown-item small" href="#" id="receive"><i class="fa fa-check text-success" aria-hidden="true"></i> Mark as Received</a>\'' : "''" ?>
                        + <?= $admin ? '\'<a class="dropdown-item small" href="#" id="decline"><i class="fa fa-times text-danger" aria-hidden="true"></i> Mark as Declined</a>\'' : "''" ?>
                        + '</div>').appendTo('body');
