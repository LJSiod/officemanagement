...
$query = "SELECT qi.id, qi.queueno, qi.servedby, qi.clientname, qi.branchid, b.Name FROM queueinfo qi LEFT JOIN branch b ON qi.branchid = b.id WHERE servedby = 4 AND status = 'SERVING' AND cashonhandstatus = 'PENDING'";
